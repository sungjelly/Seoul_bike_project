...
class RawCountMetricAccumulator:
    """Accumulates validation/test metrics on the original count scale.

    Training optimizes transformed/scaled targets, but operational evaluation
    must be in raw rental and return counts.
    """
